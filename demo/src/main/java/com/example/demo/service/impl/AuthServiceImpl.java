...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthenticationResponseDTO register(AuthenticationReqDTO req) {
        ...
        AuthenticationReqDTO authentication = new AuthenticationReqDTO();
        authentication.setUsername(req.getUsername());
        authentication.setPassword(passwordEncoder.encode(req.getPassword()));
        User user = authenticationMapper.toUser(authentication);
